...
// what it got. The DSN string is exactly what differs between the two backends —
// each ignores the other's spelling — so asserting on the string would pass on
// the build that ignores it.
