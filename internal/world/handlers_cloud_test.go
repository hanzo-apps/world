...
func TestCloudPulseServiceVolume(t *testing.T) {
	...
	upstream.HandleFunc("/v1/ai/usages/cloud", func(w http.ResponseWriter, r *http.Request) {
...
func TestCloudPulseRouterFallback(t *testing.T) {
	...
	upstream.HandleFunc("/v1/ai/usages/cloud", func(w http.ResponseWriter, _ *http.Request) {
...
func TestCloudPulseAdminLLMObservability(t *testing.T) {
	...
	api.HandleFunc("/v1/ai/usages/cloud", func(w http.ResponseWriter, _ *http.Request) { w.WriteHeader(http.StatusForbidden) })
