...
const VARIANT_META: Record<string, {
  ...
  full: {
    title: 'Hanzo World — Real-Time Global Intelligence',
    description: 'Hanzo World — AI-powered real-time global intelligence dashboard: live news, markets, strategic posture, infrastructure and geopolitical data in one view.',
    keywords: 'Hanzo, global intelligence, geopolitical dashboard, world news, market data, strategic posture, real-time monitoring, situation awareness, prediction markets',
    url: 'https://world.hanzo.ai/',
    siteName: 'Hanzo World',
    shortName: 'HanzoWorld',
  ...
  ai: {
    title: 'AI Monitor - Real-Time AI, ML & Compute Dashboard',
    description: 'Real-time AI dashboard tracking AI/ML news, research, model and inference markets, chips, cloud infrastructure, datacenters, policy and AI prediction markets worldwide.',
    keywords: 'AI dashboard, machine learning, LLM news, AI research, arxiv, inference, GPU, datacenters, cloud regions, AI policy, AI regulation, model releases, OpenAI, Anthropic, semiconductors, AI predictions',
    url: 'https://world.hanzo.ai/?variant=ai',
    siteName: 'AI Monitor',
    shortName: 'AIMonitor',
    subject: 'AI, Machine Learning, and Compute Infrastructure Intelligence',
    classification: 'AI Dashboard, ML Tracker, Compute Intelligence',
    categories: ['news', 'business'],
    features: [
      'AI/ML news aggregation',
      'AI research feeds (ArXiv)',
      'Chips & inference tracking',
      'Cloud & datacenter mapping',
  ...
  fund: {
    title: 'Lux Macro — Real-Time Rotation Terminal',
    description: 'Lux Fund macro terminal: a 3D-globe rotation model reading capital flows between AI, semis and the energy complex in real time, with the Lux Book — the top-10 model allocation, rebalanced live.',
    keywords: 'macro dashboard, sector rotation, relative rotation graph, RRG, AI trade, semiconductors, energy, natural gas, uranium, nuclear power, model allocation, market radar, macro research, fund positioning, Lux',
    url: 'https://lux.fund/',
    siteName: 'Lux Macro',
    shortName: 'LuxMacro',
    subject: 'Macro Rotation Intelligence and Model Allocation',
    classification: 'Macro Dashboard, Rotation Model, Fund Positioning',
    categories: ['finance', 'news'],
    features: [
      '3D-globe macro terminal',
      'Relative rotation graph (RRG)',
      'AI → energy rotation detection',
      'The Lux Book — top-10 model allocation',
      'Commodity & energy hub mapping',
      'Real-time market radar',
      'Central bank & macro monitoring',
      'Investment news over the globe',
    ],
  },
  crypto: {
    title: 'Crypto Monitor - Real-Time Digital Assets & Markets Dashboard',
    description: 'Real-time crypto dashboard tracking CoinGecko prices, BTC dominance and funding, ETF flows, stablecoins, market radar, sector heatmap, sentiment and prediction markets worldwide.',
    keywords: 'crypto dashboard, bitcoin, ethereum, digital assets, BTC ETF, stablecoins, DeFi, funding rates, BTC dominance, crypto news, coingecko, market radar, sector heatmap, crypto regulation, prediction markets',
    url: 'https://world.hanzo.ai/?variant=crypto',
    siteName: 'Crypto Monitor',
    shortName: 'CryptoMonitor',
    subject: 'Crypto, Digital Assets, and Market Intelligence',
    classification: 'Crypto Dashboard, Digital Asset Tracker, Market Intelligence',
    categories: ['finance', 'news'],
    features: [
      'Live CoinGecko prices',
      'BTC ETF flow tracking',
      'Stablecoin monitoring',
      'Trader desk (dominance & funding)',
      'Market radar signals',
      'Sector heatmap',
