...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  {
    ...
    apiRoutes: ['/v1/world/youtube/live'],
  ...
  },
  {
    ...
    apiRoutes: ['/v1/world/risk-scores'],
  ...
  },
  {
    ...
    apiRoutes: ['/v1/world/acled-conflict', '/v1/world/cloudflare-outages', '/v1/world/cyber-threats', '/v1/world/ais-snapshot', '/v1/world/opensky'],
  ...
  },
  {
    ...
    apiRoutes: ['/v1/world/summarize'],
    apiHandlers: ['internal/world/handlers_ai.go'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiRoutes: ['/v1/world/coingecko', '/v1/world/polymarket', '/v1/world/finnhub', '/v1/world/yahoo-finance'],
...
export function getDesktopReadinessChecks(localBackendEnabled: boolean): DesktopReadinessCheck[] {
  ...
  return [
    ...
    { id: 'summaries', label: 'Summaries (provider-backed or browser fallback)', ready: isFeatureAvailable('aiSummary') },
