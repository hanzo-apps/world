...
// same pipe, so this subsumes the standalone @sentry client.
//
...
function ingestKey(): string | undefined {
  const k = import.meta.env.VITE_HANZO_INGEST_KEY as string | undefined;
...
// desktop shell (matches the prior Sentry enable policy).
